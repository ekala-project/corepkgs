...
stdenv.mkDerivation (finalAttrs: {
  ...
  cmakeEntries = {
    protobuf_USE_EXTERNAL_GTEST = "ON";
    protobuf_ABSL_PROVIDER = "package";
    ${if enableShared then "protobuf_BUILD_SHARED_LIBS" else null} = "ON";
    ${if !finalAttrs.finalPackage.doCheck then "protobuf_BUILD_TESTS" else null} = "OFF";
  };
