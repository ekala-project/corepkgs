...
rec {
  ...
  image-nvim = callPackage ./modules/image-nvim { };
  ...
  luv = callPackage ./modules/luv { };
  libluv = callPackage ./modules/luv/lib.nix { };
  ...
  nfd = callPackage ./modules/nfd {
    inherit (pkgs) zenity;
  };

  readline = callPackage ./modules/readline { inherit (pkgs) readline; };
