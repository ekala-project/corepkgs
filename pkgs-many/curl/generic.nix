...
stdenv.mkDerivation (finalAttrs: {
  ...
  propagatedBuildInputs =
    ...
    ++ lib.optional computedGssSupport libkrb5
  ...
  configureFlags = [
    ...
    (lib.withFeature computedOpensslSupport "ca-fallback")
  ...
  ''
  + lib.optionalString computedScpSupport ''
