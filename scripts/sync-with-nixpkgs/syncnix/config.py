...
LOCAL_ONLY = [
    ...
    "pkgs/gtk/3.x.nix",
    "pkgs/gtk/4.x.nix",
    "pkgs/gtk/patches/2.0-clang.patch",
    "pkgs/gtk/patches/2.0-darwin-x11.patch",
    "pkgs/gtk/patches/2.0-gnome_bugzilla_557780_306776_freeciv_darwin.patch",
    "pkgs/gtk/patches/2.0-immodules.cache.patch",
    "pkgs/gtk/patches/gtk2-theme-paths.patch",
    "pkgs/gzip",
    ...
    "pkgs/linux-support/kernel/linux-rt-5.10.nix",
    "pkgs/linux-support/kernel/linux-rt-5.15.nix",
    "pkgs/linux-support/kernel/linux-rt-6.1.nix",
    "pkgs/linux-support/kernel/linux-rt-6.12.nix",
    "pkgs/linux-support/kernel/linux-rt-6.6.nix",
    "pkgs/linux-support/kernel/mptcp-config.nix",
    "pkgs/linux-support/kernel/update-rt.sh",
