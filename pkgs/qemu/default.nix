{
  ...
  libcacard ? null,
  spiceSupport ? true && !nixosTestRunner && !minimal && spice != null,
  spice ? null,
  spice-protocol,
  ncursesSupport ? !nixosTestRunner && !minimal,
  ncurses,
  usbredirSupport ? spiceSupport && usbredir != null,
  usbredir ? null,
  xenSupport ? false,
  xen ? null,
  cephSupport ? false,
  ...
  virglrenderer ? null,
  libiscsiSupport ? !minimal && libiscsi != null,
  libiscsi ? null,
  smbdSupport ? false,
  samba,
  tpmSupport ? !minimal,
  ...
  gitUpdater,
  qemu-utils ? null, # for tests attribute
}:
