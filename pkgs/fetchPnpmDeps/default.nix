# fetchPnpmDeps: Function for creating pnpm deps FOD (Fixed-Output Derivation)
#
# This creates a derivation that fetches pnpm dependencies from a pnpm-lock.yaml
